...
- Mainkan Mode Pesawat Jika Proses Cepat 400 ID Slow 200 -')
   ...
   def AppUac(self, GoblokLu=None):
    ...
    f'Instagram {self.versi_istagram} Android ({self.device_android}; {self.dpi}; {self.pxl}; asus; {str(random.choice(self.asus))}; {str(random.choice(self.asus))}; qcom; in_ID; {self.kode})',
              f'Instagram {self.versi_istagram} Android ({self.device_android}; {self.dpi}; {self.pxl}; oppo; {str(random.choice(self.oppo))}; {str(random.choice(self.oppo2))}; qcom; in_ID; {self.kode})',
              f'Instagram {self.versi_istagram} Android ({self.device_android}; {self.dpi}; {self.pxl}; micromax; {str(random.choice(self.micromax))}; {str(random.choice(self.micromax))}; qcom; in_ID; {self.kode})',
              f'Instagram {self.versi_istagram} Android ({self.device_android}; {self.dpi}; {self.pxl}; oneplus; {str(random.choice(self.oneplus))}; {str(random.choice(self.oneplus))}; qcom; in_ID; {self.kode})',
              f'Instagram {self.versi_istagram} Android ({self.device_android}; {self.dpi}; {self.pxl}; vivo; {str(random.choice(self.vivo2))}; {str(random.choice(self.vivo))}; qcom; in_ID; {self.kode})',
              f'Instagram {self.versi_istagram} Android ({self.device_android}; {self.dpi}; {self.pxl}; poco; {str(random.choice(self.poco))}; {str(random.choice(self.poco))}; qcom; in_ID; {self.kode})',
